...
* *Создать 3 разные ветки и слить разными способами. Обязательно чтоб был конфликт!*

* **Выполним метод слияния - Fast-forward**

* **Выполним метод слияния - 'ort' strategy**

Данный метод позволяет слить ветки, если были изменения как в основной, так и в побочной ветке;
