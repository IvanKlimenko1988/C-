...
3. Выполнять метод слияния с конфликтом в этой ветке не будем

# Семинар №3 - Работа с удаленным репозиториями

## На семинаре мы узнаем как работать с порталом [Github](https://github.com/)

+        Задачи на сегодня:

1. Создадим удаленный репозиторий

2. Научимся связывать удаленный репозиторий с локальным репозиторием

3. Научимся связывать локальный с удаленным репозиторием

4. Научимся вносить изменения на платформе Github

5. Отработаем команды **git push и git pull**

6. Научимся создавать **pull request** - запрос на слияние обновлений для чужого проекта